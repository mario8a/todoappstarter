...
fun TaskItem(
    ...
    onToggleCompletition: (Task) -> Unit,
    task: Task
) {
    Row(
        ...
        Checkbox(checked = task.isCompleted, onCheckedChange = { onToggleCompletition(task) })
        Column(
...
fun PreviewtaskItem() {
    TodoappstarterTheme {
        TaskItem(onClickItem = {}, onDeleteItem = {}, onToggleCompletition = {}, task = Task(
            id = "1",
            title = "Task 1",
            description = "Desc 1",
